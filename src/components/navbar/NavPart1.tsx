...
const NavPart1 = () => {
  return (
    <div className='flex items-center gap-4'>
        <a href="https://skiper-ui.com/" className='flex item-center gap-2'>
            ...
            <h4 className='font-bold txt-xl text-white'>skiper/ui</h4>
            <span className='text-[10px] border-1 border-orange-600 text-orange-600 rounded-full px-1.5'>Beta</span>
        </a>
        <a href="#" className='text-gray-400 font-medium txt-sm'>Components</a>
        <a href="#" className='text-gray-400 font-medium txt-sm'>Pricing</a>
        <a href="#" className='text-gray-400 font-medium txt-sm'>Newsletter</a>
    </div>
  )
}
